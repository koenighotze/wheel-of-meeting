...
async function setupWithHistory(page, { partnerIds = ['Alice', 'Bob', 'Charlie'], leadIds = [] } = {}) {
...
// ---------------------------------------------------------------------------
test('clearing history removes met badges from the partner list', async ({ page }) => {
  await setupWithHistory(page);
...
// ---------------------------------------------------------------------------
test('clearing Partners history does not affect Lead Developers history', async ({ page }) => {
...
// ---------------------------------------------------------------------------
test('dismissing the confirmation leaves history unchanged', async ({ page }) => {
  await setupWithHistory(page);
...
// ---------------------------------------------------------------------------
test('clear confirmation message names the active dataset', async ({ page }) => {
